...
import { FolderOpenIcon, ArrowLeftEndOnRectangleIcon, UserIcon, Bars3Icon } from "@heroicons/react/24/outline";
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {/* Overlay */}
        {drawerOpen && (
          <div className="fixed inset-0 bg-black/30 z-10 md:hidden" onClick={() => setDrawerOpen(false)} />
        )}
        ...
        {/* Main Content */}
        <div className="flex-1 m-7 overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
